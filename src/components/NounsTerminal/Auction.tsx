...
export default function Auction({
  ...
  const walletEns = (address: string | null) =>
    (data.wallets &&
      address &&
      data.wallets.find((w) => w.address === address)?.ens) ||
    null;
    ...
    <>
      ...
      <div className="auction">
        <AuctionHeader
          ...
          winner={{
            address: data.auction.winner || '',
            ens: walletEns(data.auction.winner),
          }}
          owner={{
            address: data.noun?.owner || '',
            ens: walletEns(data.noun?.owner || null),
          }}
          noun={data.noun}
          ended={ended}
